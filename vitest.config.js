...
// Remove this line: /// <reference types="vitest" />
// Type reference directives are only valid in TypeScript files (.ts, .d.ts, .tsx).
// Your file is a JavaScript file (.js), so this line should be deleted.
